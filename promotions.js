...
module.exports = async (req, res) => {
  ...
  if (req.method === "GET" && req.query.activePromos === "true") {
    ...
    // สำคัญ: กลับลำดับ array ก่อนกรอง เพื่อให้โปรโมชั่นที่สร้างล่าสุดถูกเช็ค/
    // เลือกก่อนเสมอ — ปกติโปรใหม่จะถูก push เข้าไปท้าย array เสมอ ถ้าไม่กลับ
    // ลำดับก่อน ระบบจะเจอโปรเก่าที่ยังไม่หมดอายุ (แต่แอดมินอาจลืมไปแล้ว) ก่อน
    // โปรที่เพิ่งสร้างใหม่ ทำให้ popup โชว์โปรผิดตัวไปได้ (บั๊กที่เจอจริง)
