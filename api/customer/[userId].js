...
const { addLoyaltyPoint, buildLoyaltyRewardMessage, getAllPromotions, savePromotions, generateUniquePromoCode, LOYALTY_POINTS_TARGET, LOYALTY_REWARD_DISCOUNT, LOYALTY_REWARD_VALID_MONTHS, mergeCustomerAccounts } = require("../../lib/promotions");
