...
module.exports = async (req, res) => {
  ...
  if (req.method === "POST") {
    ...
    const { code: newCode, type, value, startDate, endDate, minOrderValue, maxUses, gameUrl, gameLabel } = body;
  ...
  if (req.method === "PATCH") {
    ...
    const allowedFields = ["type", "value", "startDate", "endDate", "minOrderValue", "maxUses", "active", "gameUrl", "gameLabel"];
