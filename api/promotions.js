...
const { getAllPromotions, savePromotions, checkPromoValidity, isCurrentlyActive, calcDiscount, generateUniqueGameId, getActiveGamePromotions, createGameCode } = require("../lib/promotions");
...
const DEFAULT_GAME_TIERS = [
  { type: "percent", value: 5, title: "Little Smile", emoji: "🍋", messageTH: "วันนี้โลกอาจวุ่นวาย...แต่คุณยังน่ารักเหมือนเดิม 😊", messageEN: "The world may be busy today... but you're still adorable." },
  { type: "percent", value: 10, title: "Good Vibes", emoji: "💚", messageTH: "ไม่ต้องเก่งทุกวันก็ได้ แค่มีความสุขก็พอ 🌼", messageEN: "You don't have to be perfect every day. Just be happy." },
  { type: "percent", value: 15, title: "Lucky Day", emoji: "💜", messageTH: "วันนี้โชคกำลังเดินมาหาคุณ 🍀", messageEN: "Luck is finding its way to you today." },
  { type: "percent", value: 20, title: "Amazing!", emoji: "❤️", messageTH: "คุณเก่งกว่าที่คิดเสมอ ✨", messageEN: "You're stronger than you think." },
  { type: "percent", value: 30, title: "JACKPOT", emoji: "👑", messageTH: "จักรวาลประชุมกันแล้ว...สรุปว่าคุณควรได้รางวัลนี้! 🌈", messageEN: "The universe had a meeting... and decided you deserve this reward!" },
];
